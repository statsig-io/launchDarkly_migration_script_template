 ...
 * @param {transformResults:{statsigFeatureFlag: any, statsigFeatureFlagOverrides: any, ldFlag: any}[]} transformResults 
 * @returns {Promise<{detectedEnvironments: string[], loadResults: {ldFlag: any, statsigFeatureFlag: any, error: Error}[]}>}
 */
            ...
            try {
                ...
                if (statsigCreateResponse) {
                    ...
                    return {
                        ldFlag,
                        statsigFeatureFlag: null,
                        error: new Error("FAILED MIGRATION SCRIPT")
                    };
                }
            } catch (error) {
                return {
