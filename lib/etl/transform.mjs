...
function translateLDFlagToStatsig(flag, detectedEnvironments) {
 ...
 * @param {{ detectedEnvironments: string[], ldFlags: any[] }} extractionResults 
 * @returns {{detectedEnvironments: string[], transformResults: {statsigFeatureFlag: any, statsigFeatureFlagOverrides: any, ldFlag: any}[]}}
 */
export function transformLaunchDarklyFlagsToStatSigFlags({ ldFlags, detectedEnvironments, ...passthrough }) {
    return {
        ...passthrough,
        ldFlags,
        detectedEnvironments,
        transformResults: ldFlags.map(ldFlag => {
            const { statsigFeatureFlag, statsigFeatureFlagOverrides } = translateLDFlagToStatsig(ldFlag, detectedEnvironments);
            return {
                statsigFeatureFlag,
